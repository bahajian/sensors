...
//Click here to get the library: http://librarymanager/All#Adafruit_VCNL4040
...
void loop() {
  ...
  Serial.println(vcnl4040.getAmbientLight());
  Serial.println(vcnl4040.getInterruptStatus());
  Serial.println(vcnl4040.getAmbientLightHighThreshold());
  Serial.println(vcnl4040.getAmbientLightLowThreshold());
  Serial.println(vcnl4040.getProximityLowThreshold());
  Serial.println(vcnl4040.getProximityHighThreshold());
  Serial.println(vcnl4040.getAmbientIntegrationTime());
  Serial.println(vcnl4040.getAmbientIntegrationTime());
  Serial.println(vcnl4040.getProximityLEDCurrent());
  Serial.println(vcnl4040.getProximityLEDDutyCycle());
  Serial.println(vcnl4040.getProximityHighResolution());
